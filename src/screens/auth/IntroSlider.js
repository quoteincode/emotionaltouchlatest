...
const styles = StyleSheet.create({
  wrapper: {flex: 1, backgroundColor: color.blackBg},
  container: {
    flex: 1,
    alignItems: 'center',
  ...
  image: {width: wp(90), height: hp(50), resizeMode: 'contain'},
  title: {
    fontSize: fs(3.2),
    fontWeight: 'bold',
    color: color.white,
  ...
  skipButton: {position: 'absolute', top: hp(5), right: wp(5), zIndex: 10},
  skipText: {fontSize: fs(2), color: color.white, fontWeight: 'bold'},
  buttonRow: {
    flexDirection: 'row',
    justifyContent: 'center',
    width: '100%',
  ...
  fullWidthButton: {width: wp(80)},
  nextText: {color: color.white, fontSize: fs(2.5), fontWeight: 'bold'},
  centeredView: {alignItems: 'center', marginTop: hp(2)},
  loginButton: {marginTop: hp(2)},
  alreadyText: {fontSize: fs(2), color: color.white},
  loginText: {color: color.darkRed, fontWeight: 'bold'},
});
